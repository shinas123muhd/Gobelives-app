...
const EventPackages = () => {
  ...
  return (
    <div className='px-14 py-5'>
        <Subtitle title={"Event Packages"} desc={"Discover your next adventure with Destination, a feature designed to help you explore new places and experiences tailored just for you."}/>
