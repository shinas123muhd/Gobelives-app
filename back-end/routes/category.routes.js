 ...
 * tags:
 *   name: Categories
 *   description: Category management for admin users
 */
 ...
 *               metaTitle:
 *                 type: string
 *                 example: "Adventure Tours - GoBelives"
 *               metaDescription:
 *                 type: string
 *                 example: "Discover amazing adventure tours"
 *               keywords:
 *                 type: array
 *                 items:
 *                   type: string
 *                 example: ["adventure", "outdoor", "tours"]
 *               sortOrder:
 *                 type: number
 *                 example: 1
 *     responses:
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 *       400:
 *         description: Cannot delete category with active packages
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/ErrorResponse'
 ...
 *   patch:
 *     summary: Toggle category featured status (Admin only)
 *     tags: [Categories]
 *     security:
 *       - bearerAuth: []
 *     parameters:
